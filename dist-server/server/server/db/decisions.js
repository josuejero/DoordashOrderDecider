...
export async function listDecisionsForDriver(driverId, options = {}) {
    const pool = getDbPool();
    const { limit = 50, startDate, endDate, zone, decision, } = options;
    const decisionBool = decision === "accepted" || decision === "accept"
        ? true
